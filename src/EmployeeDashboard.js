  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center' }}>
        <FaRegComment 
          style={{ color: 'white', fontSize: '20px', marginRight: '10px', cursor: 'pointer' }}
          onClick={() => handlePageChange("employeecommunication")} 
        />
        <FaUserCircle
          onClick={toggleDropdowns}
          style={{ color: 'white', fontSize: '24px', marginRight: '10px', cursor: 'pointer' }} // Increased the size of the icon
        />
        {isDropdownOpen && (
          <div style={{
            position: 'absolute',
            right: '10px',
            top: '60px', // Adjusted to account for the larger icon size
            ...
            <div style={{ padding: '10px', cursor: 'pointer' }} onClick={() => handlePageChange("profile")}>
              Profile
            </div>
